...
const Dashboard = () => {
  // Contoh data peserta
  const pesertaData = [
    { id: 1, nama: "John Doe", jenjangpendidikan: "Mahasiswa", status: "Diterima", tanggal: "2024-08-25" },
    { id: 2, nama: "Jane Smith", jenjangpendidikan: "Mahasiswa", status: "Dalam Proses", tanggal: "2024-08-26" },
    { id: 3, nama: "Alice Johnson", jenjangpendidikan: "Pelajar", status: "Ditolak", tanggal: "2024-08-27" },
  ];
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1">
        <Sidebar className="relative z-10 w-64" /> {/* Adjust width as needed */}
