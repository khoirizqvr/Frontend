...
function profileMitra() {
  return (
    <div>
      <Tentang />
      <div className="">
        <div className=" bg-[#D24545] h-[200px] py-10 font-bold flex flex-col items-center justify-center text-center text-2xl md:text-3xl lg:text-4xl text-white px-2 ">
          <p >Visi dan Misi </p>
        ...
        <div className=" bg-[#D24545] md:h-[300px] lg:h-[400px] py-10 font-bold flex flex-col items-center justify-center text-center lg:text-4xl md:text-2xl text-white">
          <p>MOTTO </p>
          <p>Dinas Kependudukan dan Pencatatan Sipil Kota Semarang</p>
